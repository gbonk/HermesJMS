...
//        childToCenter.setLocation((screenDim.width - frameDim.width) >> 1, (screenDim.height - frameDim.height) >> 1);
    ...
    public static void synchronizeView(final JViewport masterViewport, final JViewport slaveViewport, final int orientation) {
        ...
        Object property = masterViewport.getClientProperty(CLIENT_PROPERTY_SLAVE_VIEWPORT);
        ...
        masterViewport.putClientProperty(CLIENT_PROPERTY_SLAVE_VIEWPORT, slaveViewportMap);

        property = slaveViewport.getClientProperty(CLIENT_PROPERTY_MASTER_VIEWPORT);
        if (!(property instanceof Map)) {
            property = new HashMap<JViewport, Integer>();
        }
        Map masterViewportMap = (Map) property;
        masterViewportMap.put(masterViewport, orientation);
        slaveViewport.putClientProperty(CLIENT_PROPERTY_MASTER_VIEWPORT, masterViewportMap);
    }
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            do {
                ...
                for (JViewport slaveViewport : allViewportToSync.keySet()) {
                    Object slaveProperty = slaveViewport.getClientProperty(CLIENT_PROPERTY_SLAVE_VIEWPORT);
